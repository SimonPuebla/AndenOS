          ...
          <div className="grid md:grid-cols-4 gap-0">
            {[
              ...
              },
              {
                step: '03',
                title: 'Pago único',
                desc: 'USD 490–890 todo incluido. Sin sorpresas ni honorarios extra.',
                time: 'Inmediato',
              },
              {
                step: '04',
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          <div className="card hover:shadow-[6px_6px_0px_#1A1A2E] transition-shadow">
            ...
            <div className="font-mono text-3xl font-bold mb-1">USD 490</div>
          ...
          <div className="bg-dark text-cream border-2 border-dark shadow-[4px_4px_0px_#F89A2F] p-6 hover:shadow-[6px_6px_0px_#F89A2F] transition-shadow">
            ...
            <div className="font-mono text-3xl font-bold mb-1">USD 890</div>
